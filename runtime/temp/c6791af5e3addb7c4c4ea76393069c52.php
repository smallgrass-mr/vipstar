<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\2020\mySpace\vipstar\public/../application/admin\view\information\index\add.html";i:1611649899;s:66:"D:\2020\mySpace\vipstar\application\admin\view\layout\default.html";i:1602168705;s:63:"D:\2020\mySpace\vipstar\application\admin\view\common\meta.html";i:1602168705;s:65:"D:\2020\mySpace\vipstar\application\admin\view\common\script.html";i:1602168705;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-user_id" class="form-control" name="row[user_id]" type="text" value="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" class="form-control" name="row[category_id]" type="text" value="">
            <!--<input id="c-category_id" data-rule="required" data-source="category/selectpage" data-params='{"custom[type]":"information"}' class="form-control selectpage" name="row[category_id]" type="text" value="">-->
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Selectverify'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-selectverify" data-rule="required" class="form-control" name="row[selectverify]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
